...
public class Pendekar implements Kelas {
    ...
    public void serang(Karakter self, Karakter target) {
        System.out.println(self.getName() + ", sang pendekar, menyerang " + target.getName() + " dengan " + getSenjata());
    ...
    public void gunakanKemampuan(Karakter self, Karakter target) {
        if (target.isHidup()) {
            System.out.println(self.getName() + " memukul mundur " + target.getName() + " dengan " + getPerisai());
    ...
    public void gunakanUltimate(Karakter self, Karakter target) {
        if (target.isHidup()) {
            ...
            System.out.println(self.getName() + " menyerang " + target.getName() + " dengan " + getSenjata() + " dan " + getPerisai());
            self.addHealth(30);
            self.addMana(20);
